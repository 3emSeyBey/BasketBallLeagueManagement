                ...
                >
                  <div className="flex items-center gap-3">
                    {p.imageMimeType ? (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
                        src={`/api/players/${p.id}/image`}
                        alt={p.name}
                        className="size-9 rounded-full object-cover bg-muted"
                      />
                    ) : (
                      <span className="size-9 rounded-full bg-primary/10 text-primary grid place-items-center font-semibold text-xs">
                        #{p.jerseyNumber}
                      </span>
                    )}
